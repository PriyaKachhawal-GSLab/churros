...
const listContactUpdatePayload = tools.requirePayload(`${__dirname}/assets/listsContacts-update.json`);
const contactPayload1 = tools.requirePayload(`${__dirname}/assets/contacts-create.json`);
...
suite.forElement('marketing', 'lists', { payload: payload }, (test) => {
  ...
  it('should allow CRUDS for lists/{id}/contacts', () => {
    ...
    return cloud.post(test.api, payload)
      ...
      .then(r => cloud.patch(`${test.api}/${listId}/contacts/${contactId}`, listContactUpdatePayload))
