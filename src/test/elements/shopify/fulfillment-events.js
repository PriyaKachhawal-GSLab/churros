...
const payload = tools.requirePayload(`${__dirname}/assets/ordersFulfillmentsFulfillmentEvents-create.json`);
const createFulfillment = tools.requirePayload(`${__dirname}/assets/ordersFulfillments-create.json`);
