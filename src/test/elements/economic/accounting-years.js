...
suite.forElement('erp', 'accounting-years', (test) => {
  ...
  test
     .withOptions({ qs: { where: `fromDate = '2011-01-01' ` } })
     ...
     test
        .withOptions({ qs: { where: `accountNumber = 1010 ` } })
     ...
     it('should support S for /accounting-years/:year/entires', () => {
       let id,pId;
